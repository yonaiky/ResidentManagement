                ...
                <CardHeader className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50">
                  <CardTitle className="flex items-center gap-2">
                    <div className="rounded-lg bg-blue-500/10 p-2">
                      <HeartPlus className="h-5 w-5 text-blue-600 dark:text-blue-400" />
                    </div>
                    Información del Plan
                  </CardTitle>
                  <CardDescription>
                    Complete todos los campos requeridos para crear el plan funerario
                  </CardDescription>
                </CardHeader>
