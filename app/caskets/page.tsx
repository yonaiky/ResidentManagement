...
import { CasketsTable } from "@/components/caskets/caskets-table";
            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-lg text-muted-foreground">
                    Administra el inventario de ataúdes y su disponibilidad
                  </p>
                </div>
              ...
              <Card className="card-hover">
                <CardHeader className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50">
                  ...
                  <CardDescription>
                    Lista completa del inventario de ataúdes con su información y estado
                  </CardDescription>
                </CardHeader>
