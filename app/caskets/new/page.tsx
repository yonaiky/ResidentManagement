...
import { CasketForm } from "@/components/CasketForm";
import { ArrowLeft, PackagePlus } from "lucide-react";
import Header from '@/components/layout/header';
import Sidebar from '@/components/layout/sidebar';
import { Footer } from '@/components/ui/footer';

export default function NewCasketPage() {
  return (
              ...
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-lg text-muted-foreground">
                    Agregar un nuevo ataúd al inventario
                  </p>
                </div>
              ...
              <Card className="card-hover">
                <CardHeader className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/50 dark:to-purple-950/50">
                  <CardTitle className="flex items-center gap-2">
                    ...
                    Información del Ataúd
                  </CardTitle>
                  <CardDescription>
                    Complete todos los campos requeridos para agregar el ataúd al inventario
                  </CardDescription>
                </CardHeader>
